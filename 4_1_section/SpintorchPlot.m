...
%% Msat
f1 = plotGeom(1,flipud(Msat)*1e-3,x_ticks,y_ticks,x_ticklabels,y_ticklabels);
hold on;
...
% SaveFig('figure/demux_v6/spintorch/','Msat', gcf);
...
for i = 0:1
    ...
    f2 = plotGeom(i+2,flipud(my),x_ticks,y_ticks,x_ticklabels,y_ticklabels);
    hold on;
    rectangle('Position',rectangle_pos,'EdgeColor','r')
    rectangle('Position',[60,100,641,21],'EdgeColor','k')
    rectangle('Position',[60,620,641,21],'EdgeColor','k')
...
%     SaveFig('figure/demux_v6/spintorch/','my_2050MHz', gcf);
end
