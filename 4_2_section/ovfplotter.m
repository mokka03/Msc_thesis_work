...
path = 'mumax\';
% name = 'demux_v5_B215mT_2100MHz_t.out';
% name = 'demux_v5_B215mT_2150MHz_t.out';
name = 'demux_v5_B215mT_doubleFreq_t.out';
...
% SaveFig('figure/demux_v5_B215mT/mumax/thresholding/','Msat', gcf);
...
% SaveFig('figure/demux_v5_B215mT/mumax/thresholding/','my_2150MHz', gcf);
